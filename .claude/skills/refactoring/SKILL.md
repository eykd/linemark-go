...
| [Lazy Element](#lazy-element)                     | Struct/function does almost nothing   | [simplification.md](./references/simplification.md) |
| [Middle Man](#middle-man)                         | Struct just delegates to another      | [simplification.md](./references/simplification.md) |
...
### Are there composition problems?

| Smell                                       | Symptom                                | Reference                                         |
| ------------------------------------------- | -------------------------------------- | ------------------------------------------------- |
| [Large Struct](#large-struct)               | Struct has too many responsibilities   | [inheritance.md](./references/inheritance.md)     |
| [Refused Bequest](#refused-bequest)         | Embedded struct's methods unused       | [inheritance.md](./references/inheritance.md)     |
| [Insider Trading](#insider-trading)         | Packages share too much internal data  | [encapsulation.md](./references/encapsulation.md) |
| [Alternative Classes](#alternative-classes) | Different interfaces, similar purpose  | [inheritance.md](./references/inheritance.md)     |
| [Data Struct](#data-struct)                 | Struct only has data, no behavior      | [encapsulation.md](./references/encapsulation.md) |
...
- **[simplification.md](./references/simplification.md)**: Inline Struct, Remove Dead Code, Collapse Hierarchy
- **[inheritance.md](./references/inheritance.md)**: Embedding, Composition, Replace with Delegate

## Cross-References

- **[prefactoring](../prefactoring/SKILL.md)**: Design principles to apply BEFORE writing code
- **[go-tdd](../go-tdd/SKILL.md)**: Tests must be green before refactoring
